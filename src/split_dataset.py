...
class DatasetSplitter(Step):
    ...
    def __init__(self, dataset_path, smiles_field, y_label_field, train_percentage, output_folder_path="."):
        super().__init__()
    ...
    def split(self):
        ...
        train_dataset.save_to_csv(os.path.join(self.output_folder_path, "train_dataset.csv"))
        test_dataset.save_to_csv(os.path.join(self.output_folder_path, "test_dataset.csv"))
